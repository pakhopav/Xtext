...
public class SimpleArrayBracketsImpl extends SimplePsiCompositeElementImpl implements SimpleArrayBrackets {

  public SimpleArrayBracketsImpl(@NotNull ASTNode node) {
    super(node);
  }
